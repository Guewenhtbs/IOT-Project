...
void setup() {
  ...
  display.drawString(10, 10, String(display.getWidth()));
  display.drawString(10, 30, String(display.getHeight()));
  display.display();
  delay(2000);
...
void loop() {
  ...
  display.drawXbm(
    ...
    (display.height()-Crowded_height)/2,
    Crowded_width,
    Crowded_height,
    crowded_1
  );
  ...
  display.drawXbm(
    (2*(display.width()-3*Crowded_width)/4)+Crowded_width,
    (display.height()-Crowded_height)/2,
    Crowded_width,
    Crowded_height,
    crowded_2
  ...
  display.drawXbm(
    (3*(display.width()-3*Crowded_width)/4)+2*Crowded_width,
    (display.height()-Crowded_height)/2,
    Crowded_width,
    Crowded_height,
    crowded_3
  ...
  delay(500);
  display.drawXbm(
    (display.width()-2*Position_width)/3,
    (display.height()-Position_height)/2,
    Position_width,
    Position_height,
    statiq
  );
  ...
  display.drawXbm(
    (2*(display.width()-2*Position_width)/3)+Position_width,
    (display.height()-Position_height)/2,
    Position_width,
    Position_height,
    moving
  ...
  delay(500);
  display.drawXbm(
    (display.width()-2*Visible_width)/3,
    (display.height()-Visible_height)/2,
    Visible_width,
    Visible_height,
    visible
  );
  ...
  display.drawXbm(
    (2*(display.width()-2*Visible_width)/3)+Visible_width,
    (display.height()-Visible_height)/2,
    Visible_width,
    Visible_height,
    hidden
